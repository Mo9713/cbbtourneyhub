...
export default function ChampionCallout({ champion, readOnly, ownerName }: Props) {
  ...
  return (
    <div className={`${theme.panelBg} border ${theme.borderBase} rounded-xl overflow-hidden w-full flex-shrink-0 shadow-sm flex flex-col items-center justify-center p-4 min-h-[7.5rem]`}>
