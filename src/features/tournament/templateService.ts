...
/**
 * Generates the full 63-game NCAA tournament bracket.
 * Structure: 4 regional brackets (16 teams each) feeding into
 * a Final Four + Championship.
 *
 * Rounds:
 *   1 = Round of 64 (32 games)
 *   2 = Round of 32 (16 games)
 *   3 = Sweet 16     (8 games)
 *   4 = Elite 8      (4 games)
 *   5 = Final Four   (2 games)
...
/**
 * After all games are inserted, walk every game that has a
 * next_game_id and write "Winner of Game #N" into the correct
