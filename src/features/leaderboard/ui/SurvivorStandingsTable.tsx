...
//
// Tiebreaker (M-NEW-2) is not applicable to survivor tournaments — survivor
// pools don't have a championship game score prediction, and the tiebreaker
// field on LeaderboardEntry will always be null for survivor entries. No
// tiebreaker column is rendered here. The file is otherwise unchanged.
                ...
                <div
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl border ${theme.borderBase} ${
                    ...
                    me && !entry.isEliminated
                      ? `${theme.bgMd} border-amber-500/30`
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col min-w-0">
                    <span className={`font-semibold text-sm truncate ${entry.isEliminated ? 'line-through' : theme.textBase}`}>
                      ...
                      {me && (
                        <span className="text-[10px] font-normal text-slate-500 ml-1 no-underline">(you)</span>
                      )}
                    </span>
                    {entry.isEliminated && (
                  ...
                  {/* Seed score — the survivor tiebreaker signal */}
